...
INSERT INTO SALE (EMPNO, YEAR, MONTH, PRICE) VALUES (1003, 2023, 1, 8000);
...
INSERT INTO SALE (EMPNO, YEAR, MONTH, PRICE) VALUES (1004, 2023, 2, 19000);
...
SELECT * FROM EMP WHERE JOB = '대리' AND DEPNO = 20;
SELECT * FROM EMP WHERE JOB = '차장' OR DEPNO = 30;
